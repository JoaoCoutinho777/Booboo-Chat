...
const MessageFormUI = ({setAttachment, message, handleSubmit, handleChange}) => {
    ...
    <div className='message-form-container'>
        {preview && (
            <div className='message-form-preview'>
                <img className="message-form-preview-image" alt='message-form-preview' src={preview} onLoad={() => URL.revokeObjectURL(preview)} />
